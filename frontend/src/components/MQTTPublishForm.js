...
const MQTTPublishForm = () => {
    ...
    const endpoint =
        source === 'aws'
            ? 'http://raspberrypi.local:5000/api/awsiot/topics-publish-form'
            : 'http://raspberrypi.local:5000/api/mqtt/topics-publish-form';
    ...
    return (
        <div style={{ borderWidth: "2px", borderColor: "gray", borderStyle: "solid", padding: "10px", marginTop:"100px",marginLeft:"150px",marginRight:"150px" }}>
            <Row>
                <Col sm="2"></Col> 
                <Col sm="8"><h3 className='mt-4 mb-4 ms-4'>Publish New Topic</h3></Col>  
            </Row>
            ...
            <Form className='mt-4 mb-4 ms-4 justify-content-center' onSubmit={handleSubmit(onSubmit)}>
                ...
                <SelectInput
                    ...
                    disabled={false}
                />
                <TextInput control={control} name={"interval"} label={"Time Interval"} placeholder={"Enter time interval in ms"} type={"number"} disabled={false}/>
...
export default MQTTPublishForm
